  ...
  <div class="flex relative w-full">
   <div class="flex-1">
      ...
      <div class="md:grid-cols-3 gap-5 grid w-full">
        <header class="p-4 md:sticky top-6 max-h-44 md:col-span-1 pt-[18px] flex justify-between bg-white dark:bg-color-dark-gray-darker shadow rounded-lg">
          <div class="text-color-dark-black-default dark:text-color-gray-light">
                  ...
                  <span>Enable dark mode</span>
                    <div class="inline-flex items-center space-x-4 mt-3">
                      <button type="button" v-if="theme == 'dark'" @click="togleDarkLightMode('light')"
                        class="text-[#9a6fc3] py-2 px-4 text-xs rounded border border-[#9a6fc3]  dark:hover:bg-color-dark-gray-darkest"
                      >
                      ...
                      <button v-else type="button" @click="togleDarkLightMode('dark')"
                        class="text-[#9a6fc3] py-2 px-4 text-xs rounded border border-[#9a6fc3] hover:bg-[#f0e7f8]"
                      >
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
