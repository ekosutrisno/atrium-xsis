            ...
            <div>
               <dl>
                  ...
                  <div class="input-custom-wrapper-gray">
                     ...
                     <dd class="input-custom-dd">
                        <label for="client-name" class="input-custom-label">Client name</label>
                           <input 
                              type="email" v-model="project.clientName" name="client-name" id="client-name" autocomplete="off"
                              :readonly="!isOnEdit"
                              :class="[ isOnEdit ? 'input-custom-on-edit' : 'input-custom-non-edit']"
                              class="input-custom-default" 
                           />
                  ...
                  <div class="input-custom-wrapper-white">
                     ...
                     <dd class="input-custom-dd">
                        <label for="tag" class="input-custom-label">Tags</label>
                        <div :class="[isOnEdit && onAddTags ? 'w-56 space-x-2': 'w-0']" class="flex with-transition items-center">
                           <input 
                                 ...
                                 class="input-custom-default" 
                              />
                              <button v-if="isOnEdit && !onAddTags" @click="onAddTags = !onAddTags" class="p-2 rounded bg-indigo-600 hover:bg-indigo-700" type="button">
                              ...
                              <button v-if="isOnEdit && onAddTags" @click="onAddTech" class="p-2 rounded bg-indigo-600 hover:bg-indigo-700" type="button">
                                    add
                              </button>
                        </div>
  ...
  components: { ProjectCard, GeneralProfileHeader},
   setup () {
      ...
      const state = reactive({
         project: computed(()=>projectStore.projects.filter(pro=> pro.projectId === route.params.projectId)[0]),
         isOnEdit: false,
         onAddTags: false,
         newTech: ''
      })
