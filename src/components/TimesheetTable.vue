          ...
          <table class="min-w-full divide-y divide-color-gray-darkest">
            <thead class="bg-color-dark-gray-darker">
              <tr>
                ...
                <th scope="col" class="px-6 py-3 hidden text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  Title
                </th>
                <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                  Status
            ...
            <tbody class="bg-color-dark-gray-darker divide-y divide-color-gray-darkest">
              <tr v-for="person in people" :key="person.email">
                ...
                <td class="px-6 py-4 hidden whitespace-nowrap text-sm text-gray-500">
                  {{ person.role }}
                </td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                  <a href="#" class="text-indigo-400 hover:text-indigo-500">Edit</a>
                </td>
              </tr>
            </tbody>
          </table>
