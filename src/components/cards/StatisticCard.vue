...
<router-link :to="stat.to">
   <div class="card with-transition flex flex-col shadow h-28 p-4 dark:hover:bg-opacity-60 hover:bg-color-gray-lighter dark:text-color-gray-light text-color-dark-gray-dark rounded-md border-t-[6px] dark:border-color-dark-gray-default border-[#ede1f8] dark:bg-color-dark-gray-dark bg-color-gray-lightest">
